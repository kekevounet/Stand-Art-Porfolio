...
export default function Compétences() {
  ...
  // Affichage
  return (
    <div className="w-full h-full mb-10 bg-white container" id="Compétences">
      ...
      <div className="w-full h-1/2 mb-10 gap-5 grid lg:grid-cols-2 grid-cols-1">
        {items.map((item, index) => (
          <div
            className="w-full h-52 shadow-md overflow-hidden border-t-4 border-cyan-500 cursor-pointer bg-white p-4 space-y-5 relative group" key={index}
          >
            <div className="flex">
